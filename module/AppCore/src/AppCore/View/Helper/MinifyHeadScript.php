...
class MinifyHeadScript extends HeadScript
{
	 ...
	 * @var string
	 */
	protected $regKey = 'Txl_View_Helper_MinifyHeadScript';
	...
	public function __construct(array $options = null)
	{
		if ($options !== null) {
			if (isset($options['minifyJs'])) {
				$this->setMinifyJs($options['minifyJs']);
			}
		}
		parent::__construct();
	}
    ...
    protected function isNeedToMinify($item)
    {
    ...
    protected function generateMinifyItem(array $scripts)
    {

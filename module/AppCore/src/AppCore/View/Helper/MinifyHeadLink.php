 ...
 *
 * * ** PREREQUISITES **
 * This file expects that you have installed minify in ../ZendFramworkProject/public_html/min 
 * and that it is working. If your location has changed, modify 
 * $this->minifyLocation to your current location.
 * 
 * ** USAGE **
...
class MinifyHeadLink extends HeadLink
{
	 ...
	 * @var string
	 */
	protected $minifyLocation = '/min/';
	
	/**
	 * Registry key for placeholder
	 * @var string
	 */
	protected $regKey = 'Txl_View_Helper_MinifyHeadLink';
	 ...
	 * @var array
	 */
	protected $cssExtensions = array(".css", ".css1", ".css2", ".css3");
	
	/**
	 * Flag use mini file in production environment and not in development.
	 * @var boolean
	 */
	...
	public function __construct(array $options = null)
	{
		if ($options !== null) {
			if (isset($options['minifyCss'])) {
				$this->setMinifyCss($options['minifyCss']);
			}
		}
		parent::__construct();
	}
	...
	{
		foreach ( $this->cssExtensions as $ext ) {
	...
	public function getMinifyLocation()
	{
		return $this->minifyLocation;
	}
	...
	public function setMinifyLocation($minifyLocation)
	{
		$this->minifyLocation = $minifyLocation;
		return $this;
	}
	...
	{
		return $this->getBaseUrl() . $this->minifyLocation;
	}
